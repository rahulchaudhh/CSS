...
- `index.html` → HTML structure for the exercises
- `style.css` → CSS styles applied
- `style1.css` → Alternative styles or experiments
...
- Use this folder to strengthen your understanding of CSS backgrounds.
